            ...
            <div class="flex pt-4">
              <a href="index.html">
                <img
                  ...
                  src="/index/resources/images/app-logo.png"
                  alt="logo"
                />
              </a>
            </div>
      ...
      <div class="flex items-center justify-between py-5 lg:py-6">
          <div class="flex items-center space-x-1">
            ...
            <div x-data="usePopper({placement:'bottom-start',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
              ...
              <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px auto auto 0px; margin: 0px; transform: translate(352px, 122px);" data-popper-placement="bottom-start">
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="flex">
              <button class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:hidden sm:h-9 sm:w-9">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" stroke="currentColor" fill="none" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
          <div class="card items-center justify-between lg:flex-row">
            ...
            <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="absolute top-0 right-0 m-2 lg:static">
              ...
              <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-654px, 208px);" data-popper-placement="bottom-end">
                <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                  <ul>
                    <li>
          ...
          <div class="card items-center justify-between lg:flex-row">
            ...
            <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="absolute top-0 right-0 m-2 lg:static">
              ...
              <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-72px, 208px);" data-popper-placement="bottom-end">
                <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                  <ul>
                    <li>
                      <a href="#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Action</a>
              ...
              <div class="mt-4 flex grow flex-col space-y-3.5">
                <div class="group flex items-center justify-between space-x-3">
                  <div class="flex items-center space-x-4">
                    <div class="relative flex">
                      <img
                        src="/index/resources/images/foods/food-4.jpg"
                ...
                <div class="group flex items-center justify-between space-x-3">
                  <div class="flex items-center space-x-4">
                    <div class="relative flex">
                      <img
                        src="/index/resources/images/foods/food-5.jpg"
                        class="mask is-star h-11 w-11 origin-center object-cover"
                        alt="image"
                      />
                ...
                <div class="group flex items-center justify-between space-x-3">
                  <div class="flex items-center space-x-4">
                    <div class="relative flex">
                      <img
                        src="/index/resources/images/foods/food-6.jpg"
                        class="mask is-star h-11 w-11 origin-center object-cover"
                        alt="image"
                      />
                ...
                <div class="group flex items-center justify-between space-x-3">
                  <div class="flex items-center space-x-4">
                    <div class="relative flex">
                      <img
                        src="/index/resources/images/foods/food-7.jpg"
                        class="mask is-star h-11 w-11 origin-center object-cover"
                        alt="image"
                      />
                ...
                <div class="group flex items-center justify-between space-x-3">
                  <div class="flex items-center space-x-4">
                    <div class="relative flex">
                      <img
                        src="/index/resources/images/foods/food-10.jpg"
                        class="mask is-star h-11 w-11 origin-center object-cover"
                        alt="image"
                      />
      ...
      $(document).ready(function() {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              // Update HTML element with weather information
