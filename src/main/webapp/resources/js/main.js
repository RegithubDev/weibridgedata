...
function() {
    ...
    var a, s = document.querySelector(".dropdown-style-switcher"), n = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || window.templateCustomizer.settings.defaultStyle, s = (window.templateCustomizer && s && ([].slice.call(s.children[1].querySelectorAll(".dropdown-item")).forEach(function(e) {
    ...
    s = s.querySelector("i"),
    "light" === n ? (s.classList.add("ti-sun"),
    new bootstrap.Tooltip(s,{
        title: "Light Mode",
        fallbackPlacements: ["bottom"]
    })) : "dark" === n ? (s.classList.add("ti-moon"),
    new bootstrap.Tooltip(s,{
        title: "Dark Mode",
        fallbackPlacements: ["bottom"]
...
"undefined" != typeof $ && $(function() {
    ...
    var t, a, e, s = $(".search-toggler"), n = $(".search-input-wrapper"), o = $(".search-input"), l = $(".content-backdrop");
    ...
    setTimeout(function() {
        ...
        o.on("focus", function() {
            n.hasClass("container-xxl") ? (n.find(e).addClass("container-xxl"),
            e.removeClass("container-fluid")) : n.hasClass("container-fluid") && (n.find(e).addClass("container-fluid"),
